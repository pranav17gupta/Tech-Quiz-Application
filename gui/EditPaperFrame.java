...
public class EditPaperFrame extends javax.swing.JFrame {
    ...
    private void jcSubjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcSubjectActionPerformed
        if(!validateInput()){
            JOptionPane.showMessageDialog(null,"Please choose any subject","Error",JOptionPane.ERROR_MESSAGE);
            return;
        }
        try{
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if(ans==JOptionPane.YES_OPTION)
        {
            try{
                ...
                EditQuestionsFrame editQuestions=new EditQuestionsFrame(exam);
